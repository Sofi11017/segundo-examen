...
def crear_factura():
    ...
    while True:
        ...
        if producto is None:
            ...
            subtotal = precio_con_iva * cantidad* descuento
            precio_anterior = precio_con_iva * cantidad
    ...
    for item in detalles:
        print(
            ...
            f"IVA: {item['iva']}% | "
            f"Descuento: {item['descuento']} | "
            f"Subtotal: {item['subtotal']} | "
            f"Precio anterior: {item['precio_anterior']}"
        )
...
def crear_producto():
    ...
    if opcion1 == "1":
        ...
        encabezado = ["codigo","nombre","valor","IVA", "Descuento", "valor anterior", "valor total a pagar"]
